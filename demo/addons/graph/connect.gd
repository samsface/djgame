...
class_name GraphControlConnectMode
...
func skip_(slot:GraphControlSlot) -> bool:
...
func get_best_hovering_slot_() -> GraphControlSlot:
...
func done_(slot:GraphControlSlot) -> void:
	undo_.commit_action()
	slot_._mouse_exited()
